                    ...
                    (n = this),
                        (a = function() {
                            ...
                            function m(t) {
                                if (null == t._isValid) {
                                    var e = g(t),
                                        i = n.call(e.parsedDateParts, function(
                                            t
                                        ) {
                                            return null != t;
                                        }),
                                    ...
                                    if (t._f !== a.RFC_2822) {
                                        ...
                                        (g(t).charsLeftOver = c - f),
                                            ...
                                            t._a[bt] <= 12 &&
                                                ...
                                                t._a[bt] > 0 &&
                                                (g(t).bigHour = void 0),
                                            (g(t).parsedDateParts = t._a.slice(
                                                0
                                            )),
                            ...
                            j(0, ["gg", 2], 0, function() {
                                ...
                                dt("GGGGG", nt, K),
                                dt("ggggg", nt, K),
                                mt(["gggg", "ggggg", "GGGG", "GGGGG"], function(
                                    t,
                                    e,
                                    i,
                                    n
                                ...
                                updateBezierControlPoints: function() {
                                    ...
                                    if (
                                        ...
                                        for (t = 0, e = s.length; t < e; ++t)
                                            ((i =
                                                s[t]
                                                    ._model).controlPointPreviousX = l(
                                                i.controlPointPreviousX,
                                                o.left,
                                                o.right
                                            )),
                                    ...
                                    n.scales &&
                                        ...
                                        a.each(o, function(n) {
                                            ...
                                            if (l in r && r[l].type === u)
                                                ...
                                                var h = t.scaleService.getScaleConstructor(
                                                    u
                                                );
                                                if (!h) return;
                                                (d = new h({
                            ...
                            t.Scale = a.extend({
                                ...
                                draw: function(t) {
                                    ...
                                    if (a.display) {
                                        ...
                                        if (c.drawBorder) {
                                            (s.lineWidth = r.valueAtIndexOrDefault(
                                                c.lineWidth,
                                                0
                                            )),
                                                (s.strokeStyle = r.valueAtIndexOrDefault(
                                                    c.color,
                                                    0
                                                ));
                                            var Y = e.left,
